...
#use the open function to open the json files
...
#convert the json data from format 1 to unfied format and compare it with expected result
...
#convert the json data from format 1 to unified format and compare it with expected result
